...
**`Main`** has two classes called [`Main`](https://github.com/AY2122S1-CS2103-T16-3/tp/blob/master/src/main/java/seedu/address/Main.java) and [`MainApp`](https://github.com/se-edu/addressbook-level3/tree/master/src/main/java/seedu/address/MainApp.java). It is responsible for,
...
### Model component
**API** : [`Model.java`](https://github.com/se-edu/AY2122S1-CS2103-T16-3/tp/blob/master/src/main/java/seedu/address/model/Model.java)
